...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop steaddcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "steaddcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* steaddcoin features */
        {"steaddcoin", "masternode", &masternode, true, true, false},
        {"steaddcoin", "masternodelist", &masternodelist, true, true, false},
        {"steaddcoin", "mnbudget", &mnbudget, true, true, false},
        {"steaddcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"steaddcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"steaddcoin", "mnsync", &mnsync, true, true, false},
        {"steaddcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"steaddcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use steaddcoind, or the -server option to steaddcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> steaddcoin-cli " + methodname + " " + args + "\n";
}
