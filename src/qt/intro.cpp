...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("steaddcoin Core"),
     ...
     * override -datadir in the steaddcoin.conf file in the default data directory
     * (to be consistent with steaddcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
