...
/** Utility functions used by the steaddcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render steaddcoin addresses in monospace font
...
// Parse "steaddcoin:" URI into recipient object, return true on successful parsing
