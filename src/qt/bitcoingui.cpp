                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Steaddcoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a steaddcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and steaddcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About steaddcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about steaddcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for steaddcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your steaddcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified steaddcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a steaddcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the steaddcoin Core help message to get a list with possible steaddcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("steaddcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to steaddcoin network", "", count));
}
...
{
    QString strTitle = tr("steaddcoin Core"); // default title
