                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gormint Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a gormint address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gormint: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About gormint Core"), this);
    aboutAction->setStatusTip(tr("Show information about gormint Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for gormint"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your gormint addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified gormint addresses"));
    ...
    openAction->setStatusTip(tr("Open a gormint: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the gormint Core help message to get a list with possible gormint command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("gormint Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to gormint network", "", count));
}
...
{
    QString strTitle = tr("gormint Core"); // default title
