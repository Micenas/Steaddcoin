...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("steaddcoin Core steaddcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  steaddcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded steaddcoin transaction") + "\n" +
                               "  steaddcoin-tx [options] -create [commands]   " + _("Create hex-encoded steaddcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded steaddcoin transaction
