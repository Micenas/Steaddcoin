Contributing to steaddcoin Core
============================

The steaddcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the steaddcoin Core project, and is not to be
confused with overall steaddcoin Network Protocol consensus changes.

Whether a pull request is merged into steaddcoin Core rests with the project merge
...
Patches that change steaddcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the steaddcoin consensus, it must have been
...
The project leader is the release manager for each steaddcoin Core release.
