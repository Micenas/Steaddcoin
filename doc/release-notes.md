steaddcoin Core version 2.3.0 is now available from:

  <https://github.com/steaddcoin-project/steaddcoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/steaddcoin-project/steaddcoin/issues>

Compatibility
==============

steaddcoin Core is extensively tested on multiple operating systems using
...
steaddcoin Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) steaddcoin MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode steaddcoin address
...
steaddcoin Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for steaddcoin (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with steaddcoin (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/steaddcoin-project-translations/).
