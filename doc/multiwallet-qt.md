...
In order to support loading of multiple wallets in steaddcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is steaddcoin.cpp.
...
Changes to steaddcoin.cpp
----------------------
steaddcoin.cpp is the entry point into steaddcoin-qt, and as such, will require some minor modifications to provide hooks for
