...
This mechanism has been integrated into Bitcore-Node-steaddcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/steaddcoin-Project/insight-api-steaddcoin#web-socket-api](https://github.com/steaddcoin-Project/insight-api-steaddcoin#web-socket-api) 
* API: [https://github.com/steaddcoin-Project/insight-api-steaddcoin#swifttx-transactions](https://github.com/steaddcoin-Project/insight-api-steaddcoin#swifttx-transactions) 
...
By default, the steaddcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the steaddcoin Core daemon:
